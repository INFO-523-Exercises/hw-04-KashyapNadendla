...
In Lasso, we can see that the sum of absolute weights has decreased to 3.5 which indicates a decrease in complexity in the model. Train error at 3.7 and test error at 4 remain constant with othe regression techniques used above.
